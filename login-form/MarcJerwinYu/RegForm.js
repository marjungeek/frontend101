...
var Regform = /** @class */ (function (_super) {
    ...
    function Regform(options) {
        ...
        _this_1.$btnLogin = document.getElementById('btn-login');
        _this_1.success = options.success;
        _this_1.error = options.error;
        _this_1.url = options.url;
        return _this_1;
    }
    Regform.prototype.httpRequest = function () {
    ...
    Regform.prototype.sendLogin = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Regform.prototype.listener = function () {
        var _this = this;
    ...
    Regform.prototype.validateLogin = function (response) {
