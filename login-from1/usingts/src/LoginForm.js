...
var newHttpClient_1 = require("./newHttpClient");
var LoginForm = /** @class */ (function (_super) {
    __extends(LoginForm, _super);
    function LoginForm(options) {
        var _this_1 = _super.call(this) || this;
        _this_1.$username = document.getElementById('usernameID');
        _this_1.$password = document.getElementById('PasswordID');
        _this_1.$btnLogin = document.getElementById('btnLoginID');
        _this_1.$btnToggle = document.getElementById('toggleID');
