...
var Login = /** @class */ (function (_super) {
    ...
    function Login(options) {
        ...
        _this_1.$username = document.getElementById('userNameControl');
        _this_1.$password = document.getElementById('passwordControl');
        _this_1.$buttonLogin = document.getElementById('loginControl');
    ...
    Login.prototype.httpRequest = function () {
    ...
    Login.prototype.validateLogin = function (response) {
